  ...
  mutate(
    ...
    # TYPE 1:  INCORRECT ADMIN 2 - FIX ADMIN 2
     adm2_name = case_when(
      ...
      adm3_name == "gezie_gofa" ~ "gofa",
      adm3_name == "melokoza" ~ "gofa",
      adm3_name == "meneat_goldia" ~ "mirab_omo", #why is this not changing all adm3 == "meneat_goldia" to have adm2 == "mirab_omo"
      adm3_name == "meneat_shasha" ~ "mirab_omo", #same thing
      adm3_name == "maji" ~ "mirab_omo", #sane thing
      adm3_name == "surma" ~ "mirab_omo", #same thing
      adm3_name == "bero" ~ "mirab_omo", #same thing
...
cleaned_adm3_a <- cleaned_adm2_a |> 
  mutate(
    ...
    adm3_name = case_when(
      ...
      # adm_1_2_3=="gambela-agnewak-gambella"~  ##### not sure about this one could be `gambela_town`?
      ...
      adm2_name == "refugees" ~ "refugees",
      adm2_name == "itang_special_woreda" ~ "itang",
      adm3_name == "wombera" ~ "wembera",
      adm3_name == "simada" ~ "semada",
      adm3_name == "dibatie" ~ "dibate",
      adm3_name == "gambella" ~ "gambela_zuria",
      adm3_name == "mengeshi" ~ "mengesh",
      adm3_name == "digaluna_tijo" ~ "degeluna_tijo",
      adm3_name == "chora" ~ "chora_(buno_bedele)",
      adm3_name == "chewaka" ~ "chwaka",
      adm3_name == "didesa" ~ "dedesa",
      adm3_name == "deder_rural" ~ "deder",
      adm3_name == "gursum" ~ "gursum_(or)",
      adm2_name == "east_hararge" & adm3_name == "jarso" ~ "jarso_(east_hararghe)", #this one has a second h in harargHe
      adm2_name == "east_hararge" & adm3_name == "kersa" ~ "kersa_(east_hararge)", #no second H in hararge
      adm3_name == "melka_belo" ~ "melka_balo",
      adm3_name == "meyumulke" ~ "meyu_muleke",
      adm3_name == "algie_sachi" ~ "alge_sachi",
      adm2_name == "ilu_aba_bora" & adm3_name == "becho" ~ "becho_(ilu_aba_bora)",
      adm3_name == "bure" ~ "bure_(or)",
      adm3_name == "halu" ~ "halu /huka",
      adm3_name == "hurrumu" ~ "hurumu",
      adm3_name == "mettu" ~ "metu_zuria",
      adm3_name == "mettu_town" ~ "metu_town",
      adm3_name == "agaro" ~ "agaro_town",
      adm2_name == "jimma" & adm3_name == "chora_botor" ~ "chora_(jimma)",
      adm3_name == "gomma" ~ "goma",
      adm3_name == "gumey" ~ "gumay",
      adm3_name == "yayo" ~ "yayu",
      adm2_name == "jimma" & adm3_name == "kersa" ~ "kersa_(jimma)",
      adm3_name == "limu_saka" ~ "limu_seka",
      adm2_name == "jimma" & adm3_name == "mana" ~ "mena_(jimma)",
      adm3_name == "mencho" ~ "mancho",
      adm3_name == "shebe_sembo" ~ "shebe_sambo",
      adm3_name == "sokoru" ~ "sekoru",
      adm3_name == "girar_jarso" ~ "gerar_jarso",
      adm3_name == "hidhabu_abote" ~ "hidabu_abote",
      adm3_name == "burka_dimtu" ~ "burqua_dhintu",
      adm3_name == "chiro_rural" ~ "chiro_zuria",
      adm3_name == "guba_qoricha" ~ "goba_koricha",
      adm3_name == "oda_bultum" ~ "kuni_/oda_bultum",
      adm3_name == "tulo" ~ "tulo_(or)",
      adm3_name == "gezie_gofa" ~ "gezei_gofa",
      adm3_name == "melokoza" ~ "melekoza",
      adm3_name == "selamago" ~ "salamago",
      adm3_name == "selamego" ~ "salamago",
      adm3_name == "gide_bench" ~ "gidi_bench",
      adm3_name == "guraferda" ~ "gurafereda",
      adm3_name == "shie_bench" ~ "shay_bench",
      adm3_name == "siz_town" ~ "size_town",
      adm3_name == "esera" ~ "isara",
      adm3_name == "essera" ~ "isara",
      adm3_name == "gena_bossa" ~ "gena",
      adm3_name == "kechi" ~ "kachi",
      adm3_name == "mermanisa" ~ "mari_mansa",
      adm3_name == "tercha_city" ~ "tercha_town",
      adm3_name == "zaba_gazo" ~ "zabagazo",
      adm3_name == "adiyo" ~ "adiyio",
      adm3_name == "bitta" ~ "bita",
      adm3_name == "bonga" ~ "bonga_town",
      adm3_name == "shishoende" ~ "shisho_ande",
      adm3_name == "tello" ~ "tullo",
      adm3_name == "gorigesha" ~ "gori_gesha",
      adm3_name == "meneat_goldia" ~ "menit_goldiye",
      adm3_name == "meneat_shasha" ~ "menit_shasha",
      adm3_name == "andracha" ~ "anderacha",
      adm3_name == "teppi_town" ~ "tepi",
      adm3_name == "yeki_woreda" ~ "yeki",
      adm3_name == "masha_woreda" ~ "masha",
      adm3_name == "mizan_aman" ~ "mizan_aman_town",
      adm3_name == "semen_ari" ~ "north_ari",
      adm2_name == "metekel" & is.na(adm3_name) ~ "dam_workers",
