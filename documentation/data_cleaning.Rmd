...
cleaned_adm2_a <- cleaned_adm1_a |> 
  mutate(
    ...
    adm1_name= case_when(
      ...
      adm1_name == "south_west_ethiopia" & adm2_name %in%c("west_omo", "om_b_149_o") ~ "snnp",
      TRUE~adm1_name
    ),
    # TYPE 1:  INCORRECT ADMIN 2 - FIX ADMIN 2
     adm2_name = case_when(
      ...
      adm1_name == "snnp" & adm2_name == "bench_maji"~"bench_sheko" ,
